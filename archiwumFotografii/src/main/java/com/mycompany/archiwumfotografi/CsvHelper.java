...
public final class CsvHelper {
    ...
    private final String url = "muzeum-lowiectwa-i-jezdziectwa.csv";
     ...
     */
    public synchronized void writeObjectToFile(Photo object) throws IOException, IllegalArgumentException, IllegalAccessException {
    ...
    public synchronized void writeTheHeader() throws IOException {
        ...
        for (Field f : Photo.class.getDeclaredFields()) {
    ...
    public HashSet<String> readObjectsAlreadyRead() throws FileNotFoundException, IOException {
        ...
        while ((line = in.readLine()) != null) {
           archivesAlreadyRead.add(line.substring(0, line.indexOf(";")));
        }
